...
public class BeanJdbcMapper extends A_JdbcMapper  {
	...
	public static int DEFAULT_NB_MAX_RESULT = 3500;

	public BeanJdbcMapper(){
	...
	public void init(Object m) throws MapperException {
		reset();
	...
	public Object map(Object m) throws MapperException {
		return m;
	}
	public void call(Object m) throws MapperException {
		/* TODO call procedure */
	}
	public boolean existStorage(Object m) throws MapperException {
		boolean r = false;
		try {
			init(m);
	...
	public void create(Object m) throws MapperException {
		try {
			JdbcTable table;
	...
	public void initCounters(Object m) throws MapperException {
		for (String tableName : getTables().keySet()) {
	...
	public void drop(Object m) throws MapperException {
		try {
	...
	public Object insert(Object m) throws MapperException {
		try {
			String tableName;
	...
	public void delete(Object m) throws MapperException {
		try 
		{
	...
	public Object select(Object m) throws MapperException 
	{
	...
	public void selectAll(List<?> l, Object o) throws MapperException {
		try {
			List<String> dbFields;
			List<String> modelFields;
			boolean overide = false;
	...
	public void update(Object m) throws MapperException {
		try {
	...
	public Object insertOrUpdate(Object m) throws MapperException {
		if (select(m)==null)
			m = insert(m);
		else
			update(m);
	...
	public Object insertIfNotExist(Object m) throws MapperException {
	...
	private final List<String> getSqlTypes(Object m,List<String> modelFields) throws IntrospectionException, IllegalArgumentException, SecurityException, IllegalAccessException, NoSuchFieldException, MapperException {
	...
	public void addFilter(Operator logic_operator,Operator field_operator, Operator operator,String fieldName, String fieldName2, List<A_Type> values) {
		if (operator!=null&&fieldName!=null) {
			if (logic_operator!=null) getFilters().add(new JdbcFilter(logic_operator));
			if (fieldName2!=null) {
				getFilters().add(new JdbcFilter(operator,getMap(fieldName), getMap(fieldName2)));
			} else if (values!=null) {
				if (field_operator!=null) {
					getFilters().add(new JdbcFilter(operator,field_operator+"("+getMap(fieldName)+")", values));
				} else {
					getFilters().add(new JdbcFilter(operator,getMap(fieldName), values));
				}
			} else {
				getFilters().add(new JdbcFilter(operator,getMap(fieldName)));
			}
		}
	}
